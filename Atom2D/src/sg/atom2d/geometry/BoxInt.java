...
/**
 * A rectangle defined by its upper left (included) and lower right (not
 * included) corners.
 *
 * <pre>
 *   1##############
 ...
 * </pre>
 *
 * This corresponds to a Rect of width = x2 - x1 and height = y2 - y1. <p> Rect
 * and Box represents the same concept, but their different definition makes
...
public class BoxInt
     ...
     */
    public BoxInt(BoxInt box) {
        set(box.x1, box.y1, box.x2, box.y2);
    }

    /**
     * Create a new box with specified coordinates. The box includes the (x1,y1)
     * as upper left corner. The lower right corner (x2,y2) is just outside the
     * box.
     *
     ...
     */
    public BoxInt(int x1, int y1, int x2, int y2) {
        set(x1, y1, x2, y2);
    }
     ...
     */
    public BoxInt(RectangleInt rectangle) {
        x1 = rectangle.x;
        y1 = rectangle.y;
     ...
     */
    public boolean isInsideOf(BoxInt box) {
     ...
     */
    public boolean isOverlapping(BoxInt box) {
     ...
     * @return True if this box overlaps the specified rectangle, false
     * otherwise.
     */
    public boolean isOverlapping(RectangleInt rectangle) {
