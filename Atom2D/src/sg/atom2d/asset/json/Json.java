 ...
 * usage: https://code.google.com/p/libgdx/wiki/JsonParsing
 *
 * @author Nathan Sweet
 */
public class Json {
     ...
     * when required to avoid ambiguity during deserialization. Set to null to
     * never output this information, but be warned that deserialization may
     * fail.
     */
    ...
    /**
     * Sets the writer where JSON output will go. This is only necessary when
