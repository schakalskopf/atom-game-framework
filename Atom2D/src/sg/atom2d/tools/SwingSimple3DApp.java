...
public class SwingSimple3DApp extends SimpleApplication {
     ...
     */
    private static SwingSimple3DApp selfRef;

    /**
     * Constructs singleton instance of Object.
     */
    protected SwingSimple3DApp() {
        selfRef = this;
    }
     ...
     */
    public static final SwingSimple3DApp getInstance() {
        if (selfRef == null) {
            selfRef = new SwingSimple3DApp();
        }
        return selfRef;
    }
