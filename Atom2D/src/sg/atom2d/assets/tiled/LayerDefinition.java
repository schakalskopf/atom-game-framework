...
public class LayerDefinition implements Serializable {
    ...
    private int height;
    /**
     * Name of the layer that MUST be one of the available: <ul> <li>0_floor
     * <li>1_terrain <li>2_object <li>3_roof <li>4_roof_add <li>objects
     * <li>collision <li>protection </ul>.
     */
    private String name;
    /**
