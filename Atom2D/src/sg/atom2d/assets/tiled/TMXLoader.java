...
public class TMXLoader implements AssetLoader {
    ...
    private MapStructure stendhalMap;
    ...
    private TileSetDefinition unmarshalTileset(final Node t) throws Exception {
        ...
        set.tileWidth = getAttribute(t, "tilewidth", 32);
        set.tileHeight = getAttribute(t, "tileheight", 32);
    ...
    private void buildMap(final Document doc) throws Exception {
        ...
        if ((mapWidth > 0) && (mapHeight > 0)) {
            stendhalMap = new MapStructure(mapWidth, mapHeight);
        }
