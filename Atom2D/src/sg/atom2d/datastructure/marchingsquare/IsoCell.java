...
package sg.atom2d.datastructure.marchingsquare;
...
public class IsoCell {
    ...
    /**
     * Clear neighbor info in this cell.  When building up shapes, it is
     * possible to have disjoint isoshapes and holes in them.  An easy way
     * to build up a new shape from neighborInfo is to build sub-paths for
     * one isoline at a time.  As the shape is built up, it is necessary to
     * erase the line afterward so that subsequent searches for isolines will
     * not loop infinitely.
     * @param prev 
     */
