...
public class RTree implements SpatialIndex2D, Serializable {
    ...
    /**
     * @see com.infomatiq.jsi.SpatialIndex#nearestNUnsorted(Point,
     * TIntProcedure, int, float)
     */
    ...
    /**
     * @see com.infomatiq.jsi.SpatialIndex#nearestN(Point, TIntProcedure, int,
     * float)
     */
     ...
     *
     * This implementation of nearestN is only suitable for small values of N
     * (ie less than 10).
     */
