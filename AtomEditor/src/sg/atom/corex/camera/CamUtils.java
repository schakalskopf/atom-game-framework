 ...
 * @author hungcuong
 */
public class CamUtils implements ActionListener {

    private Camera cam;
    private FlyByCamera flyCam;
    private InputManager inputManager;

    public CamUtils(Camera cam, FlyByCamera flyCam, InputManager inputManager) {
        this.cam = cam;
        this.flyCam = flyCam;
    ...
    public void zoomExtends(EditorSpatialInfo spatialInfo) {
    }
}
