...
import atom.corex.scenegraph.spatial.HelperSpatial;
...
import atom.corex.scenegraph.shape.BoxShape;
import atom.corex.scenegraph.shape.CylinderShape;
...
public class GizmoHelper extends AbstractHelper implements ActionListener, AnalogListener {
    ...
    public void onAnalog(String name, float value, float tpf) {
        Geometry targetObj = commonTool.getSelectionManager().getCurrentSelectedObject();
        if (targetObj != null) {
