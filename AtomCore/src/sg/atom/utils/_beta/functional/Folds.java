...
public class Folds {
    ...
    /**
     * Left folds the supplied function over the supplied values using the
     ...
     *
     * @exception NoSuchElementException thrown if values does not contain at
     * least one element.
     */
    ...
    /**
     * Sums the supplied collection of numbers to an int with a left to right
     * fold.
     */
    ...
    /**
     * Sums the supplied collection of numbers to a long with a left to right
     * fold.
     */
    ...
    /**
     * Sums the supplied collection of numbers to a float with a left to right
     * fold.
     */
    ...
    /**
     * Sums the supplied collection of numbers to a double with a left to right
     * fold.
     */
    ...
    /**
     * Sums the supplied collection of numbers to a bigint with a left to right
     * fold.
     */
