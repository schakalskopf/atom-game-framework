...
/**
 * Stand for the side effect just as in Jedi's Command<T> or Functional Javas's
 * Effect<T>. Side effect is the effect happends after a function or a execution finish.
 *
 * Read this:
