 ...
 */
public class MultiThreadSerialExecutor
        implements Executor {
    ...
    public static interface ExecutorTask {
        ...
        /**
         * This will be called when one task is on the queue to be processed and
         * another task is going to be added to the queue.
         *
        ...
        /**
         * After the task has been executed, this will be called on the
         * ResultReceiver thread to post-process the results of the task.
         */
    ...
    /**
     * Construct the SerialExecutor, using a 30-second default timeout for
     * posted Runnables.
     */
    public MultiThreadSerialExecutor(Executor receiver) {
        this(receiver, 30L * 1000L);
    }

    /**
     * Construct the SerialExecutor, using the specified timeout for posted
     * Runnables.
     */
    public MultiThreadSerialExecutor(Executor receiver, long runnableTimeout) {
        _receiver = receiver;
    ...
    /**
     * Add a task to the executor, it is expected that this method is called on
     * the ResultReceiver thread.
     */
    ...
    /**
     * Returns the number of ExecutorTasks that are currently waiting on the
     * queue.
     */
