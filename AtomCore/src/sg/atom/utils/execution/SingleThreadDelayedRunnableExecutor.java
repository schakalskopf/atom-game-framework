 ...
 */
@Deprecated
public class SingleThreadDelayedRunnableExecutor implements Executor {
    ...
    public SingleThreadDelayedRunnableExecutor() {
        actionQueue = new ArrayList<DelayedRunnableAction>(DEFAULT_QUEUE_ENTRIES);
    }

    public SingleThreadDelayedRunnableExecutor(int entries) {
