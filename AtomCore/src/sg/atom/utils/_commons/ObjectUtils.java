...
public abstract class ObjectUtils {
     ...
     *
     * @return {@code true} if the array is empty or {@code null}, {@code false}
     * otherwise
     */
     ...
     * array (if necessary of primitive wrapper objects). <p>A {@code null}
     ...
     * are {@code
     * null} or {@code false} if only one is {@code null}. <p>Compares arrays
     * with {@code Arrays.equals}, performing an equality check based on the
     ...
     * Object#hashCode()}. If the object is an array, this method will delegate
     * to any of the {@code nullSafeHashCode} methods for arrays in this class.
     * If the object is {@code null}, this method returns 0.
     *
     ...
     * {@code null}; otherwise returns an empty String. <p>Differs from
     * {@link #nullSafeToString(Object)} in that it returns an empty String
    ...
    /**
     * Determine the class name for the given object. <p>Returns {@code "null"}
    ...
    /**
     * Return a String representation of the specified Object. <p>Builds a
     * String representation of the contents in case of an array. Returns
