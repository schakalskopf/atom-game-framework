...
public final class Strings {
    ...
    public static String dumpByte(byte octet) {
        return new String(new byte[]{'0', 'x', HEX_CHAR[(octet & 0x00F0) >> 4], HEX_CHAR[octet & 0x000F]});
    }
    ...
    /**
     * Helper function that dump an array of bytes in hex pair form, without
     * '0x' and space chars
     *
     * @param buffer The bytes array to dump
     * @return A string representation of the array of bytes
    ...
    private static final byte[] UTF8 = new byte[]{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A,
