...
public class StringUtils {
    ...
    public static double getDouble(final CharSequence text, int beginIndex) {
        ...
        if (beginIndex == 0) {
            ...
            String PATTERN = StringUtils.concat("(.{", beginIndex, "})(", REGEX_DOUBLE + ")");
    ...
    public static boolean isVersionGreaterOrEqual(String ver1, String ver2) {
        ...
        int[] version1 = StringUtils.parseVersion(ver1);
        int[] version2 = StringUtils.parseVersion(ver2);
    ...
    public static boolean hasWord(String string, String word) {
        ...
        while (index >= 0) {
            ...
            if (StringUtils.isWord(string, index, length)) {
                return true;
            }
