...
public class PersistedNode<K, V> extends AbstractPage<K, V>
{
    ...
    public PersistedNode( BTree<K, V> btree, long revision, int nbElems )
    {
     ...
     */
    @SuppressWarnings("unchecked")
    public PersistedNode( BTree<K, V> btree, long revision, K key, Page<K, V> leftPage, Page<K, V> rightPage )
    {
