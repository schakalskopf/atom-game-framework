 ...
 */
public class BTreeOperationException extends RuntimeException
{
     ...
     */
    public BTreeOperationException( String explanation )
    {
        super( explanation );
    }
     ...
     * Creates a new instance of BTreeOperationException.
     */
    public BTreeOperationException( Throwable cause )
    {
        super( cause );
    }
     ...
     */
    public BTreeOperationException( String explanation, Throwable cause )
    {
