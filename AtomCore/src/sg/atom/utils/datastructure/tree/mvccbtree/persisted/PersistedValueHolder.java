...
import sg.atom.utils.datastructure.tree.mvccbtree.AbstractValueHolder;
import sg.atom.utils.datastructure.tree.mvccbtree.BTree;
import sg.atom.utils.datastructure.tree.mvccbtree.BTreeFactory;
...
import sg.atom.utils.datastructure.tree.mvccbtree.exception.BTreeAlreadyCreatedException;
...
public class PersistedValueHolder<V> extends AbstractValueHolder<V>
{
     ...
     */
    public PersistedValueHolder( BTree<?, V> parentBtree, int nbValues, byte[] raw )
    {
     ...
     */
    public PersistedValueHolder( BTree<?, V> parentBtree, V... values )
    {
        this.parentBtree = ( PersistedBTree<V, V> ) parentBtree;
        this.valueSerializer = parentBtree.getValueSerializer();
        valueThresholdUp = PersistedBTree.valueThresholdUp;
     ...
     */
    public void setSubBtree( BTree<V, V> subBtree )
    {
        valueBtree = subBtree;
        raw = null;
        valueArray = null;
