...
import sg.atom.utils.datastructure.tree.mvccbtree.memory.InMemoryBTreeConfiguration;
import sg.atom.utils.datastructure.tree.mvccbtree.memory.InMemoryLeaf;
import sg.atom.utils.datastructure.tree.mvccbtree.memory.InMemoryBTree;
import sg.atom.utils.datastructure.tree.mvccbtree.memory.InMemoryNode;
...
public class BTreeFactory<K, V>
{
     ...
     */
    public static <K, V> Page<K, V> createLeaf( BTree<K, V> btree, long revision, int nbElems )
    {
     ...
     */
    public static <K, V> Page<K, V> createNode( BTree<K, V> btree, long revision, int nbElems )
    {
        if ( btree.getType() == BTreeTypeEnum.PERSISTED )
        {
     ...
     */
    public static <K, V> void setValue( BTree<K, V> btree, Page<K, V> page, int pos, ValueHolder<V> value )
    {
        if ( btree.getType() == BTreeTypeEnum.PERSISTED )
        {
     ...
     * @param value the value to inject
     */
    public static <K, V> void setPage( BTree<K, V> btree, Page<K, V> page, int pos, Page<K, V> child )
    {
        if ( btree.getType() == BTreeTypeEnum.PERSISTED )
        {
     ...
     */
    public static <K, V> Page<K, V> getRootPage( BTree<K, V> btree )
    {
     ...
     */
    public static <K, V> LinkedList<ParentPos<K, V>> getPathToRightMostLeaf( BTree<K, V> btree )
    {
     ...
     * @return a LinkedList of all the nodes and the final leaf
     */
    public static <K, V> LinkedList<ParentPos<K, V>> getPathToLeftMostLeaf( BTree<K, V> btree )
    {
        if ( btree instanceof PersistedBTree )
        {
            LinkedList<ParentPos<K, V>> stack = new LinkedList<ParentPos<K, V>>();
