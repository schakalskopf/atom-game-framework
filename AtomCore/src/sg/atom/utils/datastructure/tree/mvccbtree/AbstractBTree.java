...
public abstract class AbstractBTree<K, V> implements BTree<K, V>
{
     ...
     */
    public Tuple<K, V> delete( K key, long revision ) throws IOException
    {
        return delete( key, null, revision );
    }


    public abstract Tuple<K, V> delete( K key, V value, long revision ) throws IOException;
     ...
     * {@inheritDoc}
     */
    public abstract InsertResult<K, V> insert( K key, V value, long revision ) throws IOException;
