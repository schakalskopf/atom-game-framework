 ...
 */
public class BTreeCreationException extends RuntimeException
{
     ...
     */
    public BTreeCreationException( String explanation )
    {
        super( explanation );
    }
     ...
     * Creates a new instance of BTreeCreationException.
     */
    public BTreeCreationException( Throwable cause )
    {
        super( cause );
    }
     ...
     */
    public BTreeCreationException( String explanation, Throwable cause )
    {
