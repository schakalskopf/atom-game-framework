...
import sg.atom.utils.datastructure.tree.mvccbtree.persisted.PersistedValueHolder;
import sg.atom.utils.datastructure.tree.mvccbtree.persisted.PersistedBTree;
import sg.atom.utils.datastructure.tree.mvccbtree.persisted.PersistedNode;
import sg.atom.utils.datastructure.tree.mvccbtree.persisted.PersistedBTreeConfiguration;
import sg.atom.utils.datastructure.tree.mvccbtree.persisted.PersistedLeaf;
import sg.atom.utils.datastructure.tree.mvccbtree.persisted.PersistedPageHolder;
import sg.atom.utils.datastructure.tree.mvccbtree.persisted.PersistedKeyHolder;
import java.io.File;
...
import sg.atom.utils.datastructure.tree.mvccbtree.exception.BTreeAlreadyManagedException;
import sg.atom.utils.datastructure.tree.mvccbtree.exception.BTreeCreationException;
import sg.atom.utils.datastructure.tree.mvccbtree.exception.EndOfFileExceededException;
import sg.atom.utils.datastructure.tree.mvccbtree.exception.FreePageException;
import sg.atom.utils.datastructure.tree.mvccbtree.exception.InvalidBTreeException;
import sg.atom.utils.datastructure.tree.mvccbtree.exception.KeyNotFoundException;
import sg.atom.utils.datastructure.tree.mvccbtree.exception.RecordManagerException;
import sg.atom.utils.datastructure.serializer.ElementSerializer;
import sg.atom.utils.datastructure.serializer.IntSerializer;
import sg.atom.utils.datastructure.serializer.LongArraySerializer;
import sg.atom.utils.datastructure.serializer.LongSerializer;
import sg.atom.utils._commons.Strings;
...
public class RecordManager
{
     ...
     */
    public <K, V> void updateBtreeHeader( BTree<K, V> btree, long rootPageOffset )
        throws EndOfFileExceededException,
        IOException
    {
     ...
     */
    public <K, V> PageHolder<K, V> writePage( BTree<K, V> btree, Page<K, V> newPage,
     ...
     */
    public <K, V> void storeRootPage( BTree<K, V> btree, Page<K, V> rootPage ) throws IOException
    {
        if ( !isKeepRevisions() )
        {
            return;
     ...
     */
    public <K, V> Page<K, V> getRootPage( BTree<K, V> btree, long revision ) throws KeyNotFoundException,
        IOException
    {
     ...
     * @throws EndOfFileExceededException
     */
    public <K, V> void addFreePages( BTree<K, V> btree, List<Page<K, V>> pages )
        throws EndOfFileExceededException,
        IOException
    {
        if ( ( btree == copiedPageBTree ) || ( btree == revisionBTree ) )
     ...
     */
    public <K, V> BTree<K, V> loadDupsBTree( long offset )
    {
        try
        {
            PageIO[] pageIos = readPageIOs( offset, Long.MAX_VALUE );
     ...
     */
    public  <K, V> Map<Page<?, ?>, BTree<?, ?>> getPendingPages()
    {
        return pendingPages;
    }
