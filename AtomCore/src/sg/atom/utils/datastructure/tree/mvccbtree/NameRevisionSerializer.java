...
import sg.atom.utils.datastructure.serializable.SerializerCreationException;
import sg.atom.utils.datastructure.serializer.AbstractElementSerializer;
import sg.atom.utils.datastructure.serializer.BufferHandler;
import sg.atom.utils.datastructure.serializer.ByteArraySerializer;
import sg.atom.utils.datastructure.serializer.IntSerializer;
import sg.atom.utils.datastructure.serializer.LongSerializer;
import sg.atom.utils.datastructure.serializer.StringSerializer;
 ...
 */
public class NameRevisionSerializer extends AbstractElementSerializer<NameRevision>
{
    /**
     * Create a new instance of a NameRevisionSerializer
     */
    public NameRevisionSerializer()
    {
     ...
     */
    public static NameRevision deserialize( byte[] in )
    {
     ...
     * @return A NameRevision instance
     */
    public static NameRevision deserialize( byte[] in, int start )
    {
     ...
     */
    public static byte[] serialize( byte[] buffer, int start, NameRevision revisionName )
    {
        if ( revisionName.getName() != null )
        {
            byte[] stringBytes = Strings.getBytesUtf8( revisionName.getName() );
