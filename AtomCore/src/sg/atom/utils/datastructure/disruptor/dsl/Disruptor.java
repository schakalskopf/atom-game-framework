...
import sg.atom.utils.datastructure.disruptor.BatchEventProcessor;
import sg.atom.utils.event.EventFactory;
import sg.atom.utils.event.EventHandler;
import sg.atom.utils.event.EventProcessor;
import sg.atom.utils.event.EventTranslator;
import sg.atom.utils.event.EventTranslatorOneArg;
import sg.atom.utils.datastructure.disruptor.ExceptionHandler;
import sg.atom.utils.datastructure.disruptor.RingBuffer;
...
import sg.atom.utils.datastructure.disruptor.TimeoutException;
import sg.atom.utils.datastructure.disruptor.wait.WaitStrategy;
import sg.atom.utils.datastructure.disruptor.WorkHandler;
import sg.atom.utils.datastructure.disruptor.RingWorkerPool;
import sg.atom.utils.datastructure.disruptor.util.Util;
...
public class Disruptor<T>
{
    ...
    EventHandlerGroup<T> createWorkerPool(final Sequence[] barrierSequences, final WorkHandler<T>[] workHandlers)
    {
        ...
        final RingWorkerPool<T> workerPool = new RingWorkerPool<T>(ringBuffer, sequenceBarrier, exceptionHandler, workHandlers);
