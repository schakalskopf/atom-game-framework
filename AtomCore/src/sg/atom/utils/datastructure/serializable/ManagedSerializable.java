 ...
 * ManagedObject} instance. This class is primarily intended to allow class that
 * does not implement {@code ManagedObject} to be persistently stored and
 ...
 *         inventoryRef = AtomContext.getDataManager().
 *             createReference(
...
public class ManagedSerializable<T> implements ManagedObject, Serializable {
     ...
     * {@code ManagedObject}, or if {@code object} is not {@code null} and does
