...
import sg.atom.utils.datastructure.state.builder.StateMachineBuilder;
import sg.atom.utils.datastructure.state.impl.MutableTransitionModelImpl;
...
public class Fettle {
    ...
    /**
     * Constructs a new transition model that holds the definition for a state
     * machine
     *
    ...
    /**
     * Constructs a new builder object to simplify the construction of state
     * machines
     *
     * @param stateClass the class of the states in the machine
     * @param eventClass the class of the events triggering state transitions
