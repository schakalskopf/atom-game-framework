...
**/
  protected final void incCount() { count_++; incVersion(); }

/**
 * Decrement the element count and update version_
**/
  protected final void decCount() { count_--; incVersion(); }
...
**/
  protected final void setCount(int c) { 
    if (c != count_) { count_ = c; incVersion(); }
  }
