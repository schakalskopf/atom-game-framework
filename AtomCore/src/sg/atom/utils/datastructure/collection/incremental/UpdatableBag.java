 ...
 */
package sg.atom.utils.datastructure.collection.incremental;
...
*
    ...
    /**
     * Add an occurrence of the indicated element if it is not already present
     * in the collection. No effect if the element is already present.
     *
     * @param element the element to add
     * @return condition:      <PRE>
...
*
    ...
    /**
     * Add all elements of the enumeration to the collection. Behaviorally
     * equivalent to
     * <PRE>
