 ...
 * size. <br> <br> This map performs very fast get, containsKey, and remove
 * (typically O(1), worst case O(log(n))). Put may be a bit slower, depending on
 * hash collisions. Load factors greater than 0.91 greatly increase the chances
 * the map will have to rehash to the next higher POT size.
 *
 * @author Nathan Sweet
 */
public class LongMap<V> {
    ...
    public void shrink(int maximumCapacity) {
        ...
        maximumCapacity = AtomFastMath.nextPowerOfTwo(maximumCapacity);
