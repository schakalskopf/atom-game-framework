 ...
 * mechanics for BoundedPriorityQueue. <p> The class currently uses a standard
 * array-based heap, as described in, for example, Sedgewick's Algorithms text.
 * All methods are fully synchronized. In the future, it may instead use
 * structures permitting finer-grained locking. <p>[<a
