...
public class ScalableDeque<E> extends AbstractCollection<E>
     ...
     */
    public int hashCode() {
        return AtomContext.getDataManager().createReference(this).hashCode();
    }
    ...
    private E removeElement(Element<E> e) {
        ...
        AtomContext.getDataManager().removeObject(e);
    ...
    static class Element<E> implements Serializable, ManagedObject {
        ...
        public Element(E value, Long id) {
            ...
            if (value instanceof ManagedObject) {
                valueRef = AtomContext.getDataManager().createReference(value);
                this.value = null;
                useRef = true;
            } else {
                this.value = value;
    ...
    static class BidirectionalDequeIterator<E>
        ...
        BidirectionalDequeIterator(ScalableDeque<E> deque, boolean isReverse) {
            ...
            dequeRef = AtomContext.getDataManager().createReference(deque);
    ...
    private static class AsynchronousClearTask<E>
         ...
         */
        public void run() {
            while (AtomContext.getTaskManager().shouldContinue() &&
                   curElement != null) {
