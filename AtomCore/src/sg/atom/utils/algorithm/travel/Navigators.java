...
import sg.atom.utils.algorithm.travel.search.Dfs;
...
public final class Navigators {
     ...
     *
     * <p>The returned navigator will be serializable if the specified multimap
     * is serializable.
     *
     ...
     *
     * <p>The returned navigator will be serializable if the specified set and
     * function are serializable.
     *
     * @param domain the domain of the returned navigator
     * @param navigationFunction the function that will provide the
     * implementation of navigator's
     * {@linkplain Navigator#related(Object) related(Object)} method
     */
     ...
     *
     * @param navigator the navigator to be used to compute the transitive
     * closure of an element
     * @param object an object (defined in the
     * {@linkplain Navigator#domain() domain} of the navigator)
     ...
     *
     * <p>When the transitive closures of the objects are expected to overlap,
     * this method is likely to be more efficient than computing separately the
     * transitive closure of each object and then computing the union of them.
     *
     * @param navigator the navigator to be used to compute the transitive
     * closure of an element
     * @param objects some objects (defined in the
     * {@linkplain Navigator#domain() domain} of the navigator)
     * @return the transitive closure of the element (which includes the element
     * itself)
     */
    ...
    public static <E> List<E> topologicalOrder(Navigator<E> acyclicNavigator) {
