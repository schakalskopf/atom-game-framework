package sg.atom.utils.algorithm.travel.search;
 ...
 *
 * <p>FIXME: Replace with Graph visitor/ traversal. Include condition to be a search.
 * 
...
public class Dfs<E> {
    ...
    public final void execute(boolean allowCycles) {
