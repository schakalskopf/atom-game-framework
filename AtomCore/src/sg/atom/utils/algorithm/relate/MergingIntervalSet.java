...
import sg.atom.utils.datastructure.collection.OrderedList.Node;
...
final class MergingIntervalSet {
     ...
     * nodes of both interval sets must belong to the same instance of OrderedList).
     */
    ...
    private static class NodeComparator implements Comparator<OrderedList.Node<?>> {
