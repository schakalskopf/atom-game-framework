...
import sg.atom.utils.datastructure.collection.OrderedList;
...
import sg.atom.utils.algorithm.travel.Navigators;
...
class DefaultTransitiveRelation<E> implements TransitiveRelation<E>, Serializable {
    private final OrderedList<E> magicList = OrderedList.create();
    ...
    private static class Node<E> {
         ...
         */
        final OrderedList.Node<E> pre;
        final OrderedList.Node<E> post;
        ...
        Node(OrderedList.Node<E> pre, OrderedList.Node<E> post) {
            this.pre = pre;
            this.post = post;
        ...
        Node<E> createEnclosing(DefaultTransitiveRelation<E> owner, E value) {
            OrderedList.Node<E> newPre = owner.magicList.addAfter(pre.previous(), value);
            OrderedList.Node<E> newPost = owner.magicList.addAfter(post, (E)ENCLOSABLE_MARKER);
            markNotEnclosable();
        ...
        Node<E> createEnclosed(DefaultTransitiveRelation<E> owner, E value) {
            OrderedList.Node<E> newPre = owner.magicList.addAfter(post.previous(), value);
            OrderedList.Node<E> newPost = owner.magicList.addAfter(newPre, null); 
            return createAndRegister(owner, newPre, newPost, value);
        }

        @SuppressWarnings("unchecked") //Same as above
        static <E> Node<E> create(DefaultTransitiveRelation<E> owner, E value) {
            OrderedList.Node<E> newPre = owner.magicList.addAfter(owner.magicList.base().previous(), value);
            OrderedList.Node<E> newPost = owner.magicList.addAfter(newPre, (E)ENCLOSABLE_MARKER);
            return createAndRegister(owner, newPre, newPost, value);
        }

        static <E> Node<E> createAndRegister(DefaultTransitiveRelation<E> owner,
                OrderedList.Node<E> pre, OrderedList.Node<E> post, E value) {
