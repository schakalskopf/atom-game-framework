...
//            if ((variable_[i].getVariableType() == sg.atom.utils.algorimthm.encodings.variable.Binary.class)
//                    || (variable_[i].getVariableType() == sg.atom.utils.algorimthm.encodings.variable.BinaryReal.class)) {
