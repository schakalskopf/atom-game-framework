package sg.atom.utils.io.compress.lzf;
...
import sg.atom.utils.io.compress.Compressor;
 ...
 * </ul> <p> The LZF compressed format knows literal runs and back-references:
 * </p> <ul> <li>Literal run: directly copy bytes from input to output.</li>
 * <li>Back-reference: copy previous data to output stream, with specified
 * offset from location and length. The length is at least 3 bytes.</li> </ul>
 * <p> The first byte of the compressed stream is the control byte. For literal
