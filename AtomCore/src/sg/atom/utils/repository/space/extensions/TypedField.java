...
import sg.atom.utils.repository.space.utils.SerializeTuple;
...
public abstract class TypedField implements ILabelledField, Serializable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see sg.atom.utils.space.IField#matches(sg.atom.utils.space.IField)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see sg.atom.utils.space.IField#getType()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see sg.atom.utils.space.IField#setType(java.lang.Class)
	 */
	...
	* (non-Javadoc)
	* 
	* @see sg.atom.utils.space.extensions.IFieldLabel#setLabel(java.lang.String)
	*/
	...
	* (non-Javadoc)
	* 
	* @see sg.atom.utils.space.extensions.IFieldLabel#getLabel()
	*/
