 ...
 * {@link  sg.atom.utils.space.interfaces.IValuedField  IValueField} or to one
 * of its concrete implementations <Field>that support full Linda semantics
 * (actual and formal fields are allowed).
 *
...
public interface IField extends Cloneable {
     ...
     *
     * @param classObj the new type of this field.
