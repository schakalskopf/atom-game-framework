...
/**
 * An implementation of the {@code java.util.Map} interface that retrieves all
 * of it's values from a {@link RevisionObjectCache}.
 * <p/>
 * The returned {@code java.util.Map} is effectively a read-only
 * {@code java.util.Map}, that means that all methods which attempt to modify
 * the underlying {@code java.util.Map} will throw a
...
public class RevisionObjectCacheMap<K, V> implements Map<K, V> {
     ...
     *
     * @param rootCache the
     * {@code sg.atom.utils.repository.pojomvcc.impl.RootObjectCacheImpl} to
     * initialise this {@link RevisionObjectCacheMap} from.
     */
    ...
    /**
     * Initalises the underlying {@code java.util.Map} from the provided
    ...
    /**
     * <b>Will throw a {@code java.lang.UnsupportedOperationException} if
     * called.</b>
     *
     * @inheritDoc
     */
