...
/**
 * A {@code CacheExpiry} dictates how long revision history (tracked as a
 * {@link CacheElementRevision}) should be kept in the
 * {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}. Once the
 * {@link CacheExpiryPolicy} has determined that a {@link CacheElementRevision}
 * should no longer be kept an optional
 * {@code sg.atom.utils.repository.pojomvcc.CacheExpirationHandler} can be used
 * to keep the {@link CacheElementRevision} somewhere else.
 *
 * @author Aidan Morgan
 */
public class CacheExpiry<K, V> {
    ...
    /**
     * The {@link CacheExpirationHandler} to use, defaults to
     * {@link CacheExpiry.NoOpCacheExpirationHandler}.
     */
    private CacheExpirationHandler<K, V> handler = new NoOpCacheExpirationHandler<K, V>();

    /**
     * Creates a new {@link CacheExpiry} with a no-op
     * {@link CacheExpirationHandler} handler.
     *
    ...
    /**
     * Creates a new {@link CacheExpiry} with the provided
     * {@link CacheExpiryPolicy} and the provided
     * {@link CacheExpirationHandler}.
     *
     * @param policy The cache expiration policy.
