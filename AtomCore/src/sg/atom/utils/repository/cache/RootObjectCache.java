...
/**
 * The {@link RootObjectCache} is the base-cache for all operations. The {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}
 * does not allow modifications to be made to it directly. To make any modifications a new {@code sg.atom.utils.repository.pojomvcc.RevisionObjectCache}
...
public interface RootObjectCache<K, V> extends ObjectCache<K, V> {
  ...
  /**
   * Returns the {@link V} which has been registered with this {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}
  ...
  /**
   * Creates a "checkout" of this {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}. A checkout is a snapshot (or "working copy")
   ...
   * <p/>
   * All modifications made in the returned {@code sg.atom.utils.repository.pojomvcc.RevisionObjectCache} are independent of this
   * {@code sg.atom.utils.repository.pojomvcc.RootObjectCache} and will not be updated, unless a {@link RevisionObjectCache#update(RefreshOptions)}
   * is invoked.
   *
   * @return
   */
  ...
  /**
   * Committs all changes in the provided {@code sg.atom.utils.repository.pojomvcc.RevisionObjectCache} to this {@code sg.atom.utils.repository.pojomvcc.RootObjectCache},
  ...
  /**
   * Defines the {@code sg.atom.utils.repository.pojomvcc.CacheExpiry} that defines how and when {@code V}s
   * history should be removed from the {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}.
   *
   * @param pol
   */
  ...
  /**
   * Callback from a {@link sg.atom.utils.repository.pojomvcc.impl.RevisionObjectCacheImpl} that it is no longer being updated and therefore
