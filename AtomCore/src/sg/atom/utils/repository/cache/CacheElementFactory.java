 ...
 * <p/>
 * Implementations of this interface should be relatively performant as they
 * will potentially hold the {@link sg.atom.utils.repository.pojomvcc.RootObjectCache)'s
...
public interface CacheElementFactory<V> {
    ...
    /**
     * Creates a clone of the provided {@link V}. This should be an exact
     * duplicate of the provided {@link V} and ideally should be a deep-copy.
     *
     ...
     * <p/>
     * It is up to implementers to decide how this merge operation should be
     * conducted depending on their specific requirements.
     *
