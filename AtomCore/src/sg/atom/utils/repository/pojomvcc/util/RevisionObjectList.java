package sg.atom.utils.repository.pojomvcc.util;
...
/**
 * A {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList} allows the presentation of a set of changes to
 ...
 * {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}, without cloning all {@code V}s
 * in the {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}.
 * <p/>
 * When a {@code V} is retrieved from this {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList}
 * a clone of the original {@code V} in the {@code sg.atom.utils.repository.pojomvcc.RootObjectCache} is
...
public class RevisionObjectList<K, V> implements Iterable<V> {
   ...
   * {@code sg.atom.utils.repository.pojomvcc.RootObjectCache}. This is a direct {@link java.util.List} copy as seperate {@code java.util.List}s
   * are maintained for each revision in the {@code sg.atom.utils.repository.pojomvcc.RootObjectCache} and therefore there is no need
   ...
   * have been added to this {@code sg.atom.utils.repository.pojomvcc.RevisionObjectCache}. The order of this is important.
   */
  private List<K> addedElementKeys;

  /**
   * A {@code java.util.List} of {@code K}s for all {@code V}s that
   * have been removed from this {@code sg.atom.utils.repository.pojomvcc.RevisionObjectCache}.
   */
  private List<K> removedElementKeys;

  /**
   * A {@code java.util.List} of {@code K}s for all {@code V}s that
   * have been retrieved from this {@code sg.atom.utils.repository.pojomvcc.RevisionObjectCache}. Although they have been retrieved does not
  ...
  /**
   * The {@code sg.atom.utils.repository.pojomvcc.RootObjectCache} that owns this {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList}.
   */
  private RootObjectCache<K, V> rootCache;

  /**
   * The revision from the {@code sg.atom.utils.repository.pojomvcc.RootObjectCache} that this {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList}
   * is operating on.
   */
   ...
   * Constructor.
   *
   * @param cache    the {@code sg.atom.utils.repository.pojomvcc.RootObjectCache} that owns this {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList}.
   * @param revision the revision from the {@code sg.atom.utils.repository.pojomvcc.RootObjectCache} that this {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList}
   *                 is for.
   */
  ...
  /**
   * Returns {@code true} if this {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList} is empty, {@code false} otherwise.
   *
   * @return
   */
   ...
   * or clones the provided {@link V} (using the {@link sg.atom.utils.repository.pojomvcc.CacheElementFactory}
   * registered with the {@link sg.atom.utils.repository.pojomvcc.RootObjectCache}) to return (the clone is also inserted into
   ...
   * {@link V} in this {@link sg.atom.utils.repository.pojomvcc.RevisionObjectCache}.
   *
   * @return
   */
  ...
  /**
   * Returns a {@code List} of {@link K} which contains all of the keys currently in this {@link sg.atom.utils.repository.pojomvcc.util.RevisionObjectList}/
   *
   * @return
   */
  ...
  private class RevisionObjectListIterator<V> implements Iterator<V> {
    ...
    public void remove() {
      throw new UnsupportedOperationException("sg.atom.utils.repository.pojomvcc.util.RevisionObjectList.RevisionObjectListIterator.remove");
    }

    /**
     * Determines if the {@code sg.atom.utils.repository.pojomvcc.util.RevisionObjectList} underlying this {@code java.util.Iterator} has
