...
/**
 * A {@link RevisionKeyList} represents the set of {@link K} instances that are
 * associated with a specific revision in the {@link RootObjectCache}.
 *
 * @author Aidan Morgan
 */
public class RevisionKeyList<K> {
    ...
    /**
     * A {@code java.util.List} of {@link K} that are the keys for this
     * revision.
     */
    private List<K> keys;
    /**
    ...
    /**
     * Copy-Constructor. This will create a new {@link RevisionKeyList} with a
     * copy of the keys in the provided
     * {@code sg.atom.utils.repository.pojomvcc.RevisionKeyList} but assigned to
     * the provided revision and the {@link RevisionKeyList#revisionTime} set to
     * the current time.
     *
     ...
     *
     * @param revision the revision of this {@link RevisionKeyList}.
     * @param other a {@code java.util.List} of {@link K}s that make up the
     * revision.
     */
    ...
    /**
     * Returns the time (in milliseconds from epoch) that this revision was
     * created.
     *
    ...
    /**
     * Returns a {@code List} of {@link K}s that are in this
     * {@link RevisionKeyList}.
     *
     * @return
     */
