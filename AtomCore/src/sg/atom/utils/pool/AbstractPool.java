...
/**
 * Category별로 resource를 pooling한다.<br>
 * pool에 instance가 있으면 반환하고, 그렇지 않으면 새로 생성하여 반환한다.<br>
 * @author mulova
 *
 * @param <K>
 * @param <V>
...
public abstract class AbstractPool<K, V> {
	...
	/**
	 * instance를 pool에 반환한다.<br>
	 * instance안에 저장위치에 대한 key가 저장되어 있을때 사용한다.<br>
	 * 
	 * @param instance
	 */
	...
	/**
	 * instance를 pool에 반환한다.<br>
	 * instance안에 저장위치에 대한 key가 저장되어 있지 않을때 사용한다.<br>
	 * 
	 * @param key
	 * @param instance
	 */
