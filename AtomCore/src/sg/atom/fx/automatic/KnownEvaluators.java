 ...
 * can find by the type they work with. <p> This maintains a clean separation
 * between the core of the Timing Framework and the Swing and SWT portions by
 * using reflection to attempt to load the non-core evaluators.
 *
 * @author Tim Halloran
 */
...
*/
     ...
     *
     * @param singleton an immutable evaluator instance.
     */
    ...
    /**
     * Unregisters an immutable evaluator, making it unknown. Has no effect if
     * the passed instance was not previously registered.
     *
     * @param singleton an immutable evaluator instance.
     */
     ...
     *
     * @param <T> a type for which an evaluator is requested.
     * @param type the {@link Class} object for <tt>T</tt>.
     * @return an evaluator for <tt>T</tt>.
     *
     * @throws IllegalArgumentException if no evaluator is registered for
     * <tt>T</tt>.
     */
     ...
     *
     * @param <T> a type for which a new evaluator instance is requested.
     * @param evaluatorType the {@link Class} object for an implementation of
     * <tt>Evaluator<T></tt>.
     * @return an evaluator for <tt>T</tt>.
     *
     * @throws IllegalStateException if something goes wrong. For example, if
     * the evaluator implementation does not have a no-argument constructor.
     */
