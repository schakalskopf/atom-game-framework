package sg.atom.fx.particle.generation;
...
import sg.atom.fx.particle.AtomParticle;
import sg.atom.fx.particle.AtomParticleControl;
import sg.atom.fx.particle.AtomParticleGenerator;
 ...
 * {@link AtomParticleEmitter#setParticleInfluencer(com.jme3.effect.influencers.ParticleInfluencer) }.
...
//    private ArrayList<Integer> unusedIndices = new ArrayList<Integer>();
    ...
    @Override
    public AtomParticleEmitter clone() {
        return clone(true);
    }

    @Override
    public AtomParticleEmitter clone(boolean cloneMaterial) {
        AtomParticleEmitter clone = (AtomParticleEmitter) super.clone(cloneMaterial);
    ...
    public AtomParticleEmitter(String name, Type type, int numParticles) {
//        super(name);
...
//        particleMesh.initParticleData(this, particles.length);
     ...
     *
     * @see AtomParticleEmitter#setInWorldSpace(boolean)
     */
     ...
     *
     * <p>If set to true and the particle emitter is moved in the scene, then
...
//        return unusedIndices.size() + next;
     ...
     *
     * <p> This includes both existing and non-existing particles. The size of
     * the array is set to the
     * <code>numParticles</code> value specified in the constructor or {@link AtomParticleEmitter#setNumParticles(int)
     * }
     * method.
     *
     ...
     *
     * @see AtomParticleEmitter#setFaceNormal(com.jme3.math.Vector3f)
     */
     ...
     *
     * <p>By default, particles will face the camera, but for some effects (e.g
     * shockwave) it may be necessary to face a specific direction instead. To
     * restore normal functionality, provide
     * <code>null</code> as the argument for
     ...
     *
     * @see AtomParticleEmitter#setRotateSpeed(float)
     */
     ...
     *
     * @see AtomParticleEmitter#setRandomAngle(boolean)
     */
     ...
     *
     * @see AtomParticleEmitter#setSelectRandomImage(boolean)
     */
     ...
     *
     * <p>By default, X and Y are equal to 1, thus allowing only 1 possible
     * image to be selected, but if the particle is configured with multiple
     * images by using {@link AtomParticleEmitter#setImagesX(int) }
     * and {#link AtomParticleEmitter#setImagesY(int) } methods, then multiple
     ...
     *
     * @see AtomParticleEmitter#setFacingVelocity(boolean)
     */
     ...
     *
     * @see AtomParticleEmitter#setEndColor(com.jme3.math.ColorRGBA)
     */
     ...
     *
     * <p>The particle color at any time is determined by blending the start
     * color and end color based on the particle's current time of life relative
     * to its end of life.
     *
     ...
     *
     * @see AtomParticleEmitter#setEndSize(float)
     */
     ...
     *
     * @see AtomParticleEmitter#setGravity(com.jme3.math.Vector3f)
     */
     ...
     *
     * @see AtomParticleEmitter#setHighLife(float)
     */
     ...
     *
     * <p>The particle's lifetime/expiration is determined by randomly selecting
     * a time between low life and high life.
     *
     ...
     *
     * @see AtomParticleEmitter#setImagesX(int)
     */
     ...
     *
     * <p>To determine how multiple particle images are selected and used, see
     * the {@link AtomParticleEmitter#setSelectRandomImage(boolean) } method.
     *
     ...
     *
     * @see AtomParticleEmitter#setImagesY(int)
     */
     ...
     *
     * @see AtomParticleEmitter#setLowLife(float)
     */
     ...
     *
     * @see AtomParticleEmitter#setParticlesPerSec(float)
     */
     ...
     *
     * @see AtomParticleEmitter#setStartColor(com.jme3.math.ColorRGBA)
     */
     ...
     * @return the start color of the particles spawned.
     *
     * @see AtomParticleEmitter#setStartSize(float)
     */
    ...
    /**
     * @deprecated Use
     * AtomParticleEmitter.getParticleInfluencer().getInitialVelocity() instead.
     */
    @Deprecated
     ...
     * according to the velocity variation set in {@link AtomParticleEmitter#setVelocityVariation(float)
     * }. A particle will move toward its velocity unless it is effected by the
     * gravity.
     *
     * @deprecated This method is deprecated. Use
     * AtomParticleEmitter.getParticleInfluencer().setInitialVelocity(initialVelocity);
     * instead.
     *
     * @see AtomParticleEmitter#setVelocityVariation(float)
     * @see AtomParticleEmitter#setGravity(float)
     */
    @Deprecated
    ...
    /**
     * @deprecated This method is deprecated. Use
     * AtomParticleEmitter.getParticleInfluencer().getVelocityVariation();
     * instead.
     ...
     * given in {@link AtomParticleEmitter#setStartVel(com.jme3.math.Vector3f)
     * }, and 1 means particles are to spawn with a completely random velocity.
     *
     * @deprecated This method is deprecated. Use
     * AtomParticleEmitter.getParticleInfluencer().setVelocityVariation(variation);
     * instead.
     */
    @Deprecated
...
//                assert i <= firstUnUsed;
     ...
     *
     * <p>When a particle is disabled, it will be "frozen in time" and not
     * update.
     *
     ...
     *
     * @see AtomParticleEmitter#setEnabled(boolean)
     */
