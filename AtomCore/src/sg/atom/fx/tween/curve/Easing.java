 ...
 * by Robert Penner. This class is essentially a port from Penner's ActionScript
 * utility, with a few added tweaks.</p> <p>Examples:
 * <pre>
 *    //no tween
 ...
 * </pre></p> <a href="http://www.robertpenner.com/easing/">Robert Penner's
 * Easing Functions</a>
 *
 * @author davedes
 */
public interface Easing {
    ...
    public static abstract class Back implements Easing {
         ...
         *
         * @param overshoot the amount to overshoot by -- higher number means
         * more overshoot and an overshoot of 0 results in cubic easing with no
         * overshoot
         */
