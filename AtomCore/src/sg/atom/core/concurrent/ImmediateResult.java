 ...
 */
package sg.atom.core.concurrent;

import sg.atom.utils.concurrent.Immutable;

/**
 * ImmediateResult is an AsyncResult implementation that can be used when the
 * result is already available. It is the easiest and most common way to
 * implement the return value in a Message method.
 *
 ...
 */
@Immutable
public final class ImmediateResult<T> implements AsyncResult<T> {
     ...
     *
     * @{link Actor#result(Object)} to create new instances.
    ...
    /**
     * Returns the value immediately, as the result is always ready in this
     * implementation. It may be a copy of the original value. This
     * implementation will never throw an exception.
     */
    public T get() {
        return result;
    }
    ...
    /**
     * Always returns true, as the result is always ready in this
     * implementation.
     *
     * @return always true
     */
    ...
    /**
     * Adds a notifier. This implementation will always invoke the notifier
     * immediately in the same thread.
     *
     * @param notifier the notifier to add
     * @throws IllegalArgumentException if the argument was null
     */
    public void addNotifier(sg.atom.core.concurrent.AsyncResult.Notifier<T> notifier) {
        if (notifier == null) {
    ...
    public void removeNotifier(
            sg.atom.core.concurrent.AsyncResult.Notifier<T> notifier) {
        if (notifier == null) {
            throw new IllegalArgumentException("notifier argument was null");
        }
