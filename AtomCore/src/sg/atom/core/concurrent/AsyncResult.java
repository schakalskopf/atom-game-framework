...
public interface AsyncResult<T> {
	 ...
	 * @see AsyncResult#addNotifier(sg.atom.core.actor.AsyncResult.Notifier)
	 */
	 ...
	 * @see #await()
	 * @see #addNotifier(sg.atom.core.actor.AsyncResult.Notifier)
	 */
	public T get();
	 ...
	 * @see #addNotifier(sg.atom.core.actor.AsyncResult.Notifier)
	 * @see #isReady()
	 * @see sg.atom.core.actor.DefaultAgent#awaitAll(AsyncResult...)
	 * @see sg.atom.core.actor.DefaultAgent#awaitAny(AsyncResult...)
	 */
	public void await();
	 ...
	 * @see #removeNotifier(sg.atom.core.actor.AsyncResult.Notifier)
