...
public final class ThreadState {
    ...
    /**
     * Called by a worker to initialize itself. Does not register the worker at
     * the controller. This should have happened before the thread was created.
     *
    ...
    /**
     * Notifies the ThreadState that the current thread starts a new
     * MessageInvocation.
     *
    ...
    /**
     * Notifies the ThreadState that the current thread just ended a
     * MessageInvocation.
     *
     * @param state the new state of the thread. Should be the value returned by
     * {@link #startInvocation(MessageInvocation)}.
    ...
    /**
     * Returns the message invocation that this thread is currently executing,
     * or null if it is not busy.
     *
    ...
    /**
     * Sets the current state of the thread. This will update the scheduler's
     * statistics.
     *
    ...
    /**
     * Sets the current state of the thread to reflect the invocation of a
     * message with the specified ThreadUsage.
     *
