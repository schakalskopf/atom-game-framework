...
import sg.atom.core.actor.internal.PropertyDescriptor.PropertySource;
...
import sg.atom.utils._commons.BeanHelper;

/**
 * BeanCreator is a singleton that creates bean implementation classes for all
 * {@link Bean} classes. It works system-wide, for all Controllers.
 */
public final class BeanCreator {
    ...
    public BeanFactory getFactory(Class<?> beanClass) {
        synchronized (this) {
            ...
            if (beanClass.getAnnotation(AgentBean.class) == null) {
     ...
     * @param generatedBeanClassName the name of the class that this factory
     * will produce
     * @param bcd the bean class descriptor
     * @param synchronizeInitializers true to synchronize the initializer
     * invocations (actors do this), false otherwise
     * @return the new factory
     */
    ...
    /**
     * Writes the accessor methods for
     *
