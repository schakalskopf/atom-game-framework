...
import sg.atom.core.asset.Files.FileType;
...
public class FileHandle {
     ...
     * on the desktop that don't need any of the backends. Do not use this
     * constructor in case you write something cross-platform. Use the
     * {@link Files} interface instead.
     *
    ...
    /**
     * Creates a new absolute FileHandle for the {@link File}. Use this for
     * tools on the desktop that don't need any of the backends. Do not use this
     * constructor in case you write something cross-platform. Use the
     * {@link Files} interface instead.
     *
     * @param file the file.
     ...
     * Gdx.files.internal("dir/file.png") -> dir/file.png. backward slashes will
     * be replaced by forward slashes.
     */
    public String path() {
     ...
     * dir/dir2/file.png -> dir/dir2/file. backward slashes will be returned as
     * forward slashes.
     */
    ...
    /**
     * Returns a java.io.File that represents this file handle. Note the
     * returned file will only be usable for {@link FileType#Absolute} and
     ...
     *
     * @throws RuntimeException if the file handle represents a directory,
     ...
     * @throws RuntimeException if this file handle represents a directory, if
     * it is a {@link FileType#Classpath} or {@link FileType#Internal} file, or
     ...
     *
     * @throws RuntimeException if this file is an {@link FileType#Classpath}
     * file.
     */
     ...
     *
     * @throws RuntimeException if this file handle is a
     * {@link FileType#Classpath} or {@link FileType#Internal} and the child
     * doesn't exist.
     */
     ...
     *
     * @throws RuntimeException if this file handle is a
     * {@link FileType#Classpath} or {@link FileType#Internal} and the sibling
     ...
     * false. Note that this can be very slow for internal files on Android!
     */
    ...
    /**
     * Deletes all children of this directory, recursively. Optionally
     ...
     * file, RuntimeException is thrown, or 2) if the destination is a
     ...
     * recursively.
     *
     * @throws RuntimeException if the destination file handle is a
     * {@link FileType#Classpath} or {@link FileType#Internal} file, or copying
     * failed.
     */
     ...
     * exists.
     *
     * @throws RuntimeException if the source or destination file handle is a
     * {@link FileType#Classpath} or {@link FileType#Internal} file.
     */
