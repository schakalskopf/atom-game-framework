 ...
 * instances of
 * <code>ManagedObject</code> referred to by other managed objects or by the
 * non-managed objects they refer to. <p>
 *
 * Applications should not use instances of
 * <code>ManagedReference</code> as the values of static fields or in other
 * locations not managed by the
...
public interface ManagedReference<T> {
     ...
     * DataManager#markForUpdate DataManager.markForUpdate} before modifying the
     * returned object or any of the non-managed objects it refers to.
     *
     ...
     * <code>true</code> if the argument is a
     * <code>ManagedReference</code> that refers to the same object as this
     * reference, otherwise
     * <code>false</code>.
     *
