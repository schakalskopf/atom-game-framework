 ...
 * just manage the start and duration of the tracks; AtomCinematic manages
 * start, duration, transistion, constrants and much more, in fact it manage
 * everythings that run in a specific time in the timeline in a load balance
 * manner. It's a ultimate scheduler!
 *
