 ...
 * nodes that exist in the implementation of the Rete network for sg.atom.logic.rule.
 *
...
public abstract class ReteNode {
	 ...
	 *
	 * @param input the input of this node that is being connected to
	 *          the given input of the successor node.
	 * @param succNode the successor to be added to this node.
	 * @param succInput the input in the successor node to where the
	 *          propagated objects must be sent.
	 */
