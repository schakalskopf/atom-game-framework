...
import sg.atom.logic.rule.AbstractRuleBase;

/**
 * A discriminant node in the Rete network. A discriminant node is one
 * that has only one input and one output, and it will propagate the
 * incoming objects if some property (i.e., a boolean method call) is
 * satisfied. This kind of node doesn't have a memory of objects,
 * filtering out those that don't comply with the property.
 *
...
public class FilterReteNode extends ReteNode {
	...
	public String toString() {
		return ("FilterReteNode[ruleIndex="+ruleIndex+",declIndex="+declIndex+"]");
	}
}
