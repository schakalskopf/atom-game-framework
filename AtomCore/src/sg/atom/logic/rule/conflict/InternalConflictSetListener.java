 ...
 * is used only internally to sg.atom.logic.rule for control purposes.
 *
...
public interface InternalConflictSetListener {
	...
	/**
	 * Invoked when an element is removed from the conflict set. Elements
	 * returned by the method <code>nextElement</code> are <b>not</b>
