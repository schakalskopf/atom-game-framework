 ...
 * removed from a conflict set. This class is used only internally to
 * sg.atom.logic.rule for control purposes.
 *
...
public class InternalConflictSetEvent extends EventObject {
	 ...
	 */
	public InternalConflictSetEvent(ConflictSet source, ConflictSetElement element) {
		super(source);
