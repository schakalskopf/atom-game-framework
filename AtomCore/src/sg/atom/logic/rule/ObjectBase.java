...
/**
 * This class models the facts over which the inference engine will act. By
 * facts we mean any object that is stored in this base - there's no notion of
 * truth or falseness. A fact simply exists or doesn't.
 *
 * @version 0.03 18 Sep 2000 Implementation of the methods transferred from
 * class ObjectHashTable to this class.
 * @author Carlos Figueira Filho (<a
 * href="mailto:csff@cin.ufpe.br">csff@cin.ufpe.br</a>)
 * @history 0.01 12 Mar 2000 Class adapted from previous version of
 * sg.atom.logic.rule.
 * @history 0.02 17 Jul 2000 Cache removed, as the object base won't be used
 * intensively at the merging process anymore. The method assert now returns a
 * boolean indicating whether the object being inserted was already in this
 * base.
 */
public class ObjectBase {

    /**
     * The superclasses/subclasses mapping. Its elements will be Vectors, as
     * there can be more than one subclass per class. Actually, this word is a
     * little misused, as we consider interfaces implemented by a class as its
     * superclasses too.
     */
    private Map subClasses;
    /**
     * The class/objects mapping. Its elements will be Vectors, as there can be
     * more than one element per class.
     */
    private Map objects;
     ...
     * @return <code>true</code> if the insertion was successful (i.e., the
     * object wasn't in the base; <code>false</code> otherwise.
     */
    public boolean assertObject(Object obj) {
    ...
    /**
     * Inserts a pairs <interface, implementingClass> into the subClass map for
     * the given class, as well as the corresponding pairs for the
     ...
     *
     * @param className the name of the class whose objects are being removed
     * from this base.
     * @return all objects that are instances of the given class.
     */
     ...
     * @return <code>true</code> if the remotion was successful (i.e., the given
     * object belonged to this base); <code>false</code> otherwise.
     */
